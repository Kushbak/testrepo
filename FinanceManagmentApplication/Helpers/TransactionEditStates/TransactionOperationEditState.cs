...
{
    public class TransactionOperationEditState: TransactionEditState
    {
        public TransactionOperationEditState(TransactionEditHelper helper) : base(helper)
        { 
        ...
        {
            Helper.Model.NewScore.Balance += Helper.Model.NewOperationTypeId == 1 ? Helper.Model.NewTransactionSum : 0;
            Helper.Model.NewScore.Balance -= Helper.Model.NewOperationTypeId == 2 ? Helper.Model.NewTransactionSum : 0;
